...
7. Appendix 1: Default values for input parameters for "pixie3d.x"
8. Appendix 2: Default values for input parameters for "pixplot.x" (graphics postprocessor)
