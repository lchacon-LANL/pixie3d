...
c Local variables
      ...
      real(8)       :: prho,pvx,pvy,pvz,pax,pay,paz,ptemp
      real(8)       :: prndtl,hrtmn
      character*(3) :: bcs(6)
...
c Set defaults
      ...
      pax      = 0d0           ! Bx perturbation
      pay      = 0d0           ! By perturbation
      paz      = 0d0           ! Bz perturbation
      ...
      nc_eom_b = .false.       ! Conservative jxB in EOM
      nc_eom_v = .false.       ! Conservative hydro in EOM
